...
export default function FormularioCiudadano() {
  ...
  const handleSubmit = async (e) => {
    ...
    await enviarEmailBienvenida({
      ...
      zonaPopayan: form.zonaPopayan.length
        ? form.zonaPopayan.join(", ")
        : "N/A",
    });

    await enviarWhatsappBienvenida({
      refer: form.cedula,
      celular: "+57" + form.telefono,
    });
  };
    ...
    <div className="contenedor">
        ...
        <div className="hero-content">
          <div className="hero-text">
            ...
            <p>
              ...
              Con este formulario recopilamos información para coordinar su
              colaboración.
            </p>

            <p className="nota">
              SI DESEAS QUE SE COLOQUE EL MICROPERFORADO A TU CARRO MARCA SI EN
      ...
      <div className="card">
        ...
        >
          ...
          <label>
            Número de Cédula de Ciudadanía (Obligatorio) POR FAVOR SIN PUNTOS NI
            COMAS *
          </label>
          <input
            name="cedula"
          ...
          {form.municipio === "Popayan" && (
            <>
              <label className="full">
                Opcional ¿Si eres de Popayán en que zonas tienes influencia?
                (Vives, trabajas o haces trabajo social) SI NO ERES DE POPAYÁN
                OMITE ESTA PREGUNTA.
              </label>
          ...
          <label className="full">
            ¿Cuál es su nivel de interés para apoyar la campaña? *
          </label>
          ...
          <label>
            ¿Tienes vehículo y quieres instalar microperforado en tu carro? *
          </label>
          <select
            name="vehiculo"
            value={form.vehiculo || ""}
          ...
          <label className="full">
            ¿En qué áreas o roles le gustaría colaborar? *
          </label>
          <div className="checkbox-group full">
            {rolesOpciones.map((r) => (
          ...
          <label>
            ¿Con qué frecuencia podría dedicar tiempo a la campaña? *
          </label>
          <select
            name="frecuencia"
          ...
          >
            ...
            <option value="Ocasional">
              Ocasionalmente (Eventos puntuales)
            </option>
          ...
          <label>
            Por favor, califique su experiencia o habilidad en el uso de Redes
            Sociales (Facebook, Instagram, WhatsApp, etc.) para fines políticos
            o de difusión. *
          </label>
          <select
            name="redes"
          ...
          <label className="full">
            ¿Desea especificar algún comentario adicional o indicar otra forma
            de apoyo no mencionada?
          </label>
          <textarea
            className="full"
            name="comentario"
